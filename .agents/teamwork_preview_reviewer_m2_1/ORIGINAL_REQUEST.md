...
7. Write review report at c:\Projects\college_companion_ui\.agents\teamwork_preview_reviewer_m2_1\handoff.md and send message back to parent with your verdict (PASS/FAIL), command outputs, and detailed findings.
