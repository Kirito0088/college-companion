...
void main() {
  ...
  group('Core Screens Widget Tests with ProviderScope Overrides', () {
    testWidgets('CalendarScreen renders wrapped in ProviderScope with stream provider override', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('AssignmentsScreen renders wrapped in ProviderScope with stream provider override', (
      WidgetTester tester,
    ) async {
      final now = DateTime.now().toUtc().toIso8601String();
    ...
    testWidgets('ResourcesScreen renders wrapped in ProviderScope with stream provider override', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('SettingsScreen renders wrapped in ProviderScope with stream provider override', (
      WidgetTester tester,
    ) async {
      final now = DateTime.now().toUtc().toIso8601String();
    ...
    testWidgets('DashboardScreen renders wrapped in ProviderScope with stream provider override', (
      WidgetTester tester,
    ) async {
      tester.view.physicalSize = const Size(1200, 3000);
      tester.view.devicePixelRatio = 1.0;
    ...
    testWidgets('AttendanceScreen renders wrapped in ProviderScope with stream provider override', (
      WidgetTester tester,
    ) async {
      tester.view.physicalSize = const Size(1200, 3000);
      tester.view.devicePixelRatio = 1.0;
