...
6. Write a review report at c:\Projects\college_companion_ui\.agents\teamwork_preview_reviewer_m1_2\handoff.md and send a message back to parent with your verdict (PASS/FAIL), command outputs, and detailed findings.
